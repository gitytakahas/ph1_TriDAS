...
##################################################################################
n1=[g_poh1[i].GetN() for i in range(4)]
x1=[g_poh1[i].GetX() for i in range(4)]
y1=[g_poh1[i].GetY() for i in range(4)]
for i in range(4):
   for k in range(n1[i]):
       x1[i][k]=x1[i][k]*0.45
       y1[i][k]=y1[i][k]*0.24084
n2=[g_poh2[i].GetN() for i in range(4)]
x2=[g_poh2[i].GetX() for i in range(4)]
y2=[g_poh2[i].GetY() for i in range(4)]
for i in range(4):
   for k in range(n2[i]):
       x2[i][k]=x2[i][k]*0.45
       y2[i][k]=y2[i][k]*0.24084

n3=[g_poh3[i].GetN() for i in range(4)]
x3=[g_poh3[i].GetX() for i in range(4)]
y3=[g_poh3[i].GetY() for i in range(4)]
for i in range(4):
   for k in range(n3[i]):
       x3[i][k]=x3[i][k]*0.45
       y3[i][k]=y3[i][k]*0.24084



for i in range(4):
   g_poh1[i]= TGraph(n1[i],x1[i],y1[i])
   g_poh2[i]= TGraph(n2[i],x2[i],y2[i])
   g_poh3[i]= TGraph(n3[i],x3[i],y3[i])
