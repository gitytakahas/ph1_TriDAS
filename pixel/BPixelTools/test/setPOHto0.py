...
ccu.send("poh1 setall 3 3 3 3 0 0 0 0").readlines()
ccu.send("poh2 setall 3 3 3 3 0 0 0 0").readlines()
ccu.send("poh3 setall 3 3 3 3 0 0 0 0").readlines()
ccu.send("poh4 setall 3 3 3 3 0 0 0 0").readlines()
ccu.send("poh5 setall 3 3 3 3 0 0 0 0").readlines()
ccu.send("poh6 setall 3 3 3 3 0 0 0 0").readlines()
ccu.send("poh7 setall 3 3 3 3 0 0 0 0").readlines()
