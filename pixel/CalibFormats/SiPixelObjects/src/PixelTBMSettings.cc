...
{
 if     ( what == "TBMABase0" ) {TBMABase0_ = (unsigned char)value;}
 else if( what == "TBMBBase0" ) {TBMBBase0_ = (unsigned char)value;}
 else if( what == "TBMAAutoReset" ) {TBMAAutoReset_ = (unsigned char)value;}
