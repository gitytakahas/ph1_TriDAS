/*
   ...
   FileName : 		OfflineErrorDbUploader.cc

   Content : 		OfflineErrorDbUploader module
...
#include "OfflineErrorDbUploader.h"
...
XDAQ_INSTANTIATOR_IMPL(OfflineErrorDbUploader);
	...
	OfflineErrorDbUploader::OfflineErrorDbUploader(xdaq::ApplicationStub * s) throw (xdaq::exception::Exception): xdaq::Application(s), JsInterface(s)
#else
	OfflineErrorDbUploader::OfflineErrorDbUploader(xdaq::ApplicationStub * s) throw (xdaq::exception::Exception): xdaq::Application(s)
#endif
{
	...
	fsm_.addStateTransition ('C','H', EXECTRANSCH, this, &OfflineErrorDbUploader::haltAction);
	fsm_.addStateTransition ('H','C', EXECTRANSHC, this, &OfflineErrorDbUploader::configureAction);
	fsm_.setFailedStateTransitionAction( this, &OfflineErrorDbUploader::failedTransition );
...
//CCC	    
	...
	mmesg << "Process version " << OFFLINEERRORDBUPLOADER_PACKAGE_VERSION << " loaded";
...
diagService_->logFileName_ = "";
	...
	xgi::bind(this,&OfflineErrorDbUploader::Default, "Default");
	xgi::bind(this,&OfflineErrorDbUploader::Default1, "Default1");
	xgi::bind(this,&OfflineErrorDbUploader::callDiagSystemPage, "callDiagSystemPage");
	xgi::bind(this,&OfflineErrorDbUploader::callFsmPage, "callFsmPage");
	xgi::bind(this,&OfflineErrorDbUploader::callWriteLogsPage, "callWriteLogsPage");


	xgi::bind(this,&OfflineErrorDbUploader::configureStateMachine, "configureStateMachine");
	xgi::bind(this,&OfflineErrorDbUploader::stopStateMachine, "stopStateMachine");



	//Bind diagnostic applications
	xgi::bind(this,&OfflineErrorDbUploader::configureDiagSystem, "configureDiagSystem");
	xgi::bind(this,&OfflineErrorDbUploader::applyConfigureDiagSystem, "applyConfigureDiagSystem");
	...
	xoap::bind (this, &OfflineErrorDbUploader::fireEvent, EXECTRANSCH, XDAQ_NS_URI);
	xoap::bind (this, &OfflineErrorDbUploader::fireEvent, EXECTRANSHC, XDAQ_NS_URI);
...
OfflineErrorDbUploader::~OfflineErrorDbUploader()
{
...
void OfflineErrorDbUploader::getDefault1Content(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
	...
	*out << "<br>Number of logs read from log file : " << logsReadFromFile << "<br>" << std::endl;
...
void OfflineErrorDbUploader::getFsmStatePage(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
...
void OfflineErrorDbUploader::getForceWriteLogsPage(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
...
void OfflineErrorDbUploader::Default1(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
	internalState_ = 0;
	Default(in, out);
}
...
void OfflineErrorDbUploader::callDiagSystemPage(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
	internalState_ = 1;
	Default(in, out);
}
...
void OfflineErrorDbUploader::callFsmPage(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
	internalState_ = 2;
	Default(in, out);
}
...
// xgi method called when the link <display_fsm> is clicked
void OfflineErrorDbUploader::callWriteLogsPage(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
	internalState_ = 3;
	Default(in, out);
}
...
void OfflineErrorDbUploader::displayLinks(xgi::Input * in, xgi::Output * out)
{
...
void OfflineErrorDbUploader::Default(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
...
// Turns the OfflineErrorDbUploader into state INITIALISED (FSM point of view)
void OfflineErrorDbUploader::configureAction(toolbox::Event::Reference e) throw (toolbox::fsm::exception::Exception)
{
...
// Turns the OfflineErrorDbUploader into state HALTED (FSM point of view)
void OfflineErrorDbUploader::haltAction(toolbox::Event::Reference e) throw (toolbox::fsm::exception::Exception)
{
	// Apply fireitems value to internal variables and check validity
...
xoap::MessageReference OfflineErrorDbUploader::fireEvent (xoap::MessageReference msg) throw (xoap::exception::Exception)
{
	//#define DEBUG_FIREEVENT
	#ifdef DEBUG_FIREEVENT
		std::cout << "In OfflineErrorDbUploader : fireEvent received" << std::endl ;
	#endif
...
void OfflineErrorDbUploader::failedTransition (toolbox::Event::Reference e) throw (toolbox::fsm::exception::Exception)
{
...
void OfflineErrorDbUploader::configureStateMachine(xgi::Input * in, xgi::Output * out)
{
...
// Can be called via the <configure_FSM> hyperdaq HTML page of this process
void OfflineErrorDbUploader::stopStateMachine(xgi::Input * in, xgi::Output * out)
{
...
#ifdef AUTO_CONFIGURE_PROCESSES
void OfflineErrorDbUploader::timeExpired (toolbox::task::TimerEvent& e) 
{
...
/*
	...
	vector<xoap::SOAPElement> paramsList = mb.getChildElements ();
...
//If RunNumber has already been setted, it's ok do nothing
	...
	{
		DIAG_EXEC_FSM_INIT_TRANS
		std::cout << "OfflineErrorDbUploader(LID=" << getApplicationDescriptor()->getLocalId() << ",Instance=" << getApplicationDescriptor()->getInstance() << ") ready" << std::endl;
...
void OfflineErrorDbUploader::cleanupMsgString(std::string * msg)
{
...
std::string OfflineErrorDbUploader::cleanField(std::string& rawField, std::string& tag)
{
...
std::string OfflineErrorDbUploader::getTag(std::string& rawField)
{
	std::string tag="";
...
void OfflineErrorDbUploader::readLogsFromFile(int command)
{
...
if ( (currentRunNumberFromGedAsString_ == "") || (currentRunNumberFromGedAsString_ == "NA") || (currentRunNumberFromGedAsString_ == "N/A") || (currentRunNumberFromGedAsString_ == "0"))
{

std::cout << "Starting run number detection" << std::endl;
	if (fileIn_ != NULL) 
	{
		char oneLine[1024];
		while (NOT_EOF)
...
std::cout << "Run number read from record " << logNumber << " :  " << runnumber << std::endl;
			if ( (runnumber != "") && (runnumber != "NA") && (runnumber != "N/A") && (runnumber != "0"))
			{
				std::cout << "currentRunNumberFromGedAsString_ assigned" << std::endl;
				currentRunNumberFromGedAsString_ = runnumber;
				break;
			}
			else std::cout << "currentRunNumberFromGedAsString_ NOT assigned" << std::endl;
			
		} //EOF reached in while loop

		if ( (currentRunNumberFromGedAsString_ != "") && (currentRunNumberFromGedAsString_ != "NA") && (currentRunNumberFromGedAsString_ != "N/A") && (currentRunNumberFromGedAsString_ != "0"))
		{
			std::cout << "Run number detected as : " << currentRunNumberFromGedAsString_ << " ; will be used at next tick." << std::endl;
		}
		else std::cout << "Run number NOT detected ; aborting." << std::endl;
...
//We got the RN ; now exploit data
...
//std::cout << "Read one log in base logssource file" << std::endl;
			...
			{
//std::cout << "In OfflineErrorDbUploader, log number " << logNumber << " ready to be uploaded" << std::endl;
...
if (insertiontime < minDbUploadTime) minDbUploadTime = insertiontime;
    ...
    std::cout << "ERROR while uploading logs into DB" << std::endl;
