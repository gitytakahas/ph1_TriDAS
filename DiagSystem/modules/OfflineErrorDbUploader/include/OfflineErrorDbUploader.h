/*
   FileName : 		OfflineErrorDbUploader.h
...
#ifndef _OfflineErrorDbUploader_h_
#define _OfflineErrorDbUploader_h_
...
#include "OfflineErrorDbUploaderV.h"
...
#ifdef AUTO_CONFIGURE_PROCESSES
	#ifdef WILL_USE_GWT_FIREITEMS_VIEWER
		class OfflineErrorDbUploader: public xdaq::Application, public toolbox::task::TimerListener, public JsInterface
	#else
		class OfflineErrorDbUploader: public xdaq::Application, public toolbox::task::TimerListener
	#endif
#else
	#ifdef WILL_USE_GWT_FIREITEMS_VIEWER
		class OfflineErrorDbUploader: public xdaq::Application, public JsInterface
	#else
		class OfflineErrorDbUploader: public xdaq::Application
	#endif
#endif
{
    ...
    public:
        ...
        OfflineErrorDbUploader(xdaq::ApplicationStub * s) throw (xdaq::exception::Exception);

	~OfflineErrorDbUploader();
