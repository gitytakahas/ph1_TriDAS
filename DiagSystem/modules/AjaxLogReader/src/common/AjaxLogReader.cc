...
//FILTERING-END
	...
	xgi::bind(this,&AjaxLogReader::getJSONDiskTree, "getJSONDiskTree");
	xgi::bind(this,&AjaxLogReader::getJsJSONDiskTree, "getJsJSONDiskTree");
...
/* ADDONS FOR FILES PARSING/READING */
            xgi::bind(this,&AjaxLogReader::callParseDiskPage, "callParseDiskPage");
...
void AjaxLogReader::getRepositoryContentPage(xgi::Input * in, xgi::Output * out, std::string repositoryToParse ) throw (xgi::exception::Exception)
{
...
/* ADDONS FOR FILES PARSING/READING */
        ...
        void AjaxLogReader::callParseDiskPage(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
        {
...
/* ADDONS FOR FILES PARSING/READING */
/* Displays the available HyperDaq links for this process */
void AjaxLogReader::getDiskContent(std::string activeRepository, std::string callingAppletUid)
{
...
/* Returns the HTML page displayed from the Default() method when the <default_page> link is clicked */
void AjaxLogReader::displayDiskContent(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
...
*/
	...
	*out << cgicc::p() << std::endl;
        ...
        void AjaxLogReader::getJSONDiskTree(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
        {
	    handleIncomingJsonConnection_->take();
...
//std::cout << "exiting getJSONDiskTree" << std::endl;
        ...
        void AjaxLogReader::getJsJSONDiskTree(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
        {
	    handleIncomingJsonConnection_->take();
...
void AjaxLogReader::castDiskContentToJsonArray()
{
