/*
   FileName : 		GlobalErrorDispatcher.h
...
#ifndef _GlobalErrorDispatcher_h_
#define _GlobalErrorDispatcher_h_
...
#include "GlobalErrorDispatcherV.h"
...
#ifdef AUTO_CONFIGURE_PROCESSES
	#ifdef WILL_USE_GWT_FIREITEMS_VIEWER
		class GlobalErrorDispatcher: public xdaq::Application, public toolbox::task::TimerListener, public JsInterface
	#else
		class GlobalErrorDispatcher: public xdaq::Application, public toolbox::task::TimerListener
	#endif
#else
	#ifdef WILL_USE_GWT_FIREITEMS_VIEWER
		class GlobalErrorDispatcher: public xdaq::Application, public JsInterface
	#else
		class GlobalErrorDispatcher: public xdaq::Application
	#endif
#endif
{
...
bool isRunningForPixels_;
        ...
        GlobalErrorDispatcher(xdaq::ApplicationStub * s) throw (xdaq::exception::Exception);
