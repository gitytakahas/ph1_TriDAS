...
#ifndef _TkDashBoard_h_
#define _TkDashBoard_h_
...
#include <sentinel/dashboard/Application.h>

#include <xoap/Event.h>
#include <sentinel/utils/Serializer.h>

//class TkDashBoard: public xdaq::WebApplication
class TkDashBoard: public sentinel::dashboard::Application
{
	...
	public:
        ...
        TkDashBoard(xdaq::ApplicationStub * s) throw (xdaq::exception::Exception);
