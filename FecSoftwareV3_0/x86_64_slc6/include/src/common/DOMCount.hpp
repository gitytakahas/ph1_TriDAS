...
// ---------------------------------------------------------------------------
class DOMParseCountErrorHandler : public DOMErrorHandler
{
public:
    // -----------------------------------------------------------------------
    //  Constructors and Destructor
    // -----------------------------------------------------------------------
    DOMParseCountErrorHandler();
    ~DOMParseCountErrorHandler();
...
private :
    ...
    // -----------------------------------------------------------------------
    DOMParseCountErrorHandler(const DOMParseCountErrorHandler&);
    void operator=(const DOMParseCountErrorHandler&);
...
inline bool DOMParseCountErrorHandler::getSawErrors() const
{
    return fSawErrors;
}
