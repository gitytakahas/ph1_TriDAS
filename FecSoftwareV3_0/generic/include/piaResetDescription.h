...
*/
#ifndef PIARESETDESCRIPTION_H
#define PIARESETDESCRIPTION_H

#include "tscTypes.h"

#include "deviceDescription.h"
#include "piaResetDefinition.h"

/**
 * \class piaResetDescription
 ...
 */
class piaResetDescription: public deviceDescription {
 ...
 public:
   ...
   */
  enum PiaEnumType {PIACRATEID,PIAFECSLOT,PIARINGSLOT,PIACCUADDRESS,PIACHANNEL,DELAYACTIVERESET,INTERVALDELAYRESET,MASK} ;
  
  /** Parameter's names
   */
  static const char *PIARESETPARAMETERNAMES[MASK+1] ; //= {"crateId","fecSlot","ringSlot","ccuAddress","piaChannel","delayActiveReset","intervalDelayReset","mask"} ;
   ...
   */
  piaResetDescription ( keyType accessKey,
   ...
   * \param intervalDelayReset - time between two set
   */
  piaResetDescription ( tscType16 fecSlot,
                        tscType16 ringSlot,
   ...
   * \param intervalDelayReset - time between two set
   */
  piaResetDescription ( unsigned long delayActiveReset,
			unsigned long intervalDelayReset,
			tscType8 mask ) ;
   ...
   */
  piaResetDescription ( parameterDescriptionNameType parameterNames ) ;
