...
#include "XMLESFecDcu.h"

#include <xercesc/framework/Wrapper4InputSource.hpp>

using namespace XERCES_CPP_NAMESPACE ;

/**Create an XMLESFecDcu dedicated for DCU
 * @exception FecExceptionHandler
 * @see <I>XMLESFecDevice:XMLESFecDevice()</I>
 */
XMLESFecDcu::XMLESFecDcu () throw (FecExceptionHandler) : XMLESFecDevice () { }

#ifdef DATABASE

/**Creates a XMLESFecDcu with access to the database<BR>
 * Call the <I>XMLESFecDevice::XMLESFecDevice( ESDbFecAccess * )</I><BR>
 */
XMLESFecDcu::XMLESFecDcu ( ESDbFecAccess *dbAccess )  throw (FecExceptionHandler) : XMLESFecDevice(dbAccess) { }

#endif

/**Creates a XMLESFecDcu from a buffer<BR>
 ...
 */
XMLESFecDcu::XMLESFecDcu ( const XMLByte* xmlBuffer ) throw (FecExceptionHandler) : XMLESFecDevice( xmlBuffer ){ }

/**Creates a XMLESFecDcu from a file<BR>
 ...
 */
XMLESFecDcu::XMLESFecDcu ( std::string xmlFileName ) throw (FecExceptionHandler) : XMLESFecDevice( xmlFileName ) { }


/**Delete the <I>handler_</I> attribute<BR>
 * Delete the device vector <I>dVector_</I> attribute<BR>
 */
XMLESFecDcu::~XMLESFecDcu (){ }
 ...
 */
deviceVector XMLESFecDcu::getDevices (std::string partitionName, unsigned long timeStampStart, unsigned long timeStampStop) throw (FecExceptionHandler) {
 ...
 * @see <I>XMLESFec::parseXMLBuffer()</I>
 */
deviceVector XMLESFecDcu::getDevices (unsigned long dcuHardId, unsigned long timeStampStart, unsigned long timeStampStop) throw (FecExceptionHandler) {
 ...
 * @see <I>XMLESFec::parseXMLBuffer()</I>
 */
deviceVector XMLESFecDcu::getDevices (unsigned long timeStampStart, unsigned long timeStampStop) throw (FecExceptionHandler) {
 ...
 */
unsigned int XMLESFecDcu::parseAttributes(XERCES_CPP_NAMESPACE::DOMNode *n) {
 ...
 */
void XMLESFecDcu::setDcuValues (deviceVector dVector, std::string partitionName) throw (FecExceptionHandler){
	...
	try {
		...
		#endif
			std::string writeString("BEGIN PkgMbDcuXML.uploadXMLClob(:bufferDcu, :partitionName); END;") ;
