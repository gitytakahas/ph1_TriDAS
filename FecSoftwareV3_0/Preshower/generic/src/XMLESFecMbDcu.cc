...
#include "XMLESFecMbDcu.h"

#include <xercesc/framework/Wrapper4InputSource.hpp>

using namespace XERCES_CPP_NAMESPACE ;

/**Create an XMLESFecMbDcu dedicated for DCU
 * @exception FecExceptionHandler
 * @see <I>XMLESFecDevice:XMLESFecDevice()</I>
 */
XMLESFecMbDcu::XMLESFecMbDcu () throw (FecExceptionHandler) : XMLESFecDevice () { }

#ifdef DATABASE

/**Creates a XMLESFecMbDcu with access to the database<BR>
 * Call the <I>XMLESFecDevice::XMLESFecDevice( ESDbFecAccess * )</I><BR>
 */
XMLESFecMbDcu::XMLESFecMbDcu ( ESDbFecAccess *dbAccess )  throw (FecExceptionHandler) : XMLESFecDevice(dbAccess) { }

#endif

/**Creates a XMLESFecMbDcu from a buffer<BR>
 ...
 */
XMLESFecMbDcu::XMLESFecMbDcu ( const XMLByte* xmlBuffer ) throw (FecExceptionHandler) : XMLESFecDevice( xmlBuffer ){ }

/**Creates a XMLESFecMbDcu from a file<BR>
 ...
 */
XMLESFecMbDcu::XMLESFecMbDcu ( std::string xmlFileName ) throw (FecExceptionHandler) : XMLESFecDevice( xmlFileName ) { }


/**Delete the <I>handler_</I> attribute<BR>
 * Delete the device vector <I>dVector_</I> attribute<BR>
 */
XMLESFecMbDcu::~XMLESFecMbDcu (){ }
 ...
 */
deviceVector XMLESFecMbDcu::getDevices (std::string partitionName, unsigned long timeStampStart, unsigned long timeStampStop) throw (FecExceptionHandler) {
 ...
 * @see <I>XMLESFec::parseXMLBuffer()</I>
 */
deviceVector XMLESFecMbDcu::getDevices (unsigned long dcuHardId, unsigned long timeStampStart, unsigned long timeStampStop) throw (FecExceptionHandler) {
 ...
 * @see <I>XMLESFec::parseXMLBuffer()</I>
 */
deviceVector XMLESFecMbDcu::getDevices (unsigned long timeStampStart, unsigned long timeStampStop) throw (FecExceptionHandler) {
 ...
 */
unsigned int XMLESFecMbDcu::parseAttributes(XERCES_CPP_NAMESPACE::DOMNode *n) {
 ...
 */
void XMLESFecMbDcu::setDcuValues (deviceVector dVector, std::string partitionName) throw (FecExceptionHandler){
